# `fun-ts` Object Functional (OF)

This module contains implementations of common Functional Programming types using an Object/Functional approach.
That is, is uses classes and encapsulates logic and functions within the classes as methods. The classes are fat, but
are exposed publicly through interfaces.   

## TODO

- Customize this for the Object/Functional implementation
